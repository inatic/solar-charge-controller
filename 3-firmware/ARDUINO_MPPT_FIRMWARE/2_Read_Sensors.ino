void ADC_SetGain(){
  if(ADS1015_Mode==true){                                                    //FOR ADS1015 12-BIT ADC MODEL
    if(ADC_GainSelect==0){ads.setGain(GAIN_TWOTHIRDS);}                      // Gain: 2/3x  Range: +/- 6.144V  
    else if(ADC_GainSelect==1){ads.setGain(GAIN_ONE);}                       // Gain: 1x    Range: +/- 4.096V    
    else if(ADC_GainSelect==2){ads.setGain(GAIN_TWO);}                       // Gain: 2x    Range: +/- 2.048V       
  }
